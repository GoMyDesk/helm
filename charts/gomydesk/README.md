...
| vdi.spec.app.image | string | `ghcr.io/tinyzimmer/gomydesk:app-${VERSION}` | The image to use for app pods. |
...
| vdi.spec.metrics | object | `{"serviceMonitor":{"create":false,"labels":{"release":"prometheus"}}}` | Metrics configurations for `gomydesk`. |
